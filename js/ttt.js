 ...
 * - 43 themes to choose from, now grouped and with a customizable favorites bar.
 ...
 * - Saved squee messages. The script will maintain an "inbox" of up to the 10 most recent squees you missed.
 *
 * Special thanks to:
...
$.getScript('http://btc.berrytube.tv/toastdeib/js/lib/toastlib.js', initToastThemes);
...
function ThemeButton(id, name, themeUrl, tooltip, isNew, isUpdated) {
  ...
  this.wireListener = function(suffix) {
    ...
    button.click(function() {
      setColorTheme(themeUrl, false);
    });
    if (suffix == '') {
      button.bind('contextmenu', function(e) {
        toggleFavorited(themeUrl);
        e.preventDefault();
      });
    } else {
...
function initToastThemes(data, textStatus, jqxhr) {
  ...
  $('head').append($('<link/>').attr('rel', 'stylesheet').attr('type', 'text/css').attr('href', 'http://btc.berrytube.tv/toastdeib/js/toastthemes/toastthemes.css'));
  ...
  fourthPartyGroup = new GroupButton('fourthPartyGroup', '4th Party', isNewOrUpdated(2013, 7, 17), false);
  ...
  officialGroup.addButton(new ThemeButton('malPinkieButton', 'PinkieTube', 'http://backstage.berrytube.tv/malsententia/pinkietube.css', '', false, false));
  officialGroup.addButton(new ThemeButton('celestiaButton', 'CelestiaTube', 'http://backstage.berrytube.tv/malsententia/celestiatube.css', '', false, false));
  ...
  mainPonyGroup.addButton(new ThemeButton('scootsButton', 'ScootaTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/scoots/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('dashieButton', 'DashieTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/dashie/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('apocalypseButton', 'ApocalypseTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/apocalypse/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('ponysockButton', 'SockTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/sock/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('cmcButton', 'CMCTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/cmc/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('rarityButton', 'RarityTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/rarity/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('appleButton', 'AppleTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/apple/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('sparkleButton', 'SparkleTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/sparkle/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('flutterButton', 'FlutterTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/flutter/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('pinkieButton', 'PinkieTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/colors.css', '', false, false));
  mainPonyGroup.addButton(new ThemeButton('blazeitButton', '420BlazeItTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/blazeit/colors.css', '', false, false));

  bgPonyGroup.addButton(new ThemeButton('octav3Button', 'Octav3Tub3', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/octav3/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('tomButton', 'TomTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/tom/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('derpyButton', 'DerpyToob', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/derpy/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('twistButton', 'TwistTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/twist/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('toothpasteButton', 'ToothpasteTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/toothpaste/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('deskfuckButton', 'DeskFuckTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/deskfuck/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('fancyButton', 'FancyTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/fancy/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('teiButton', 'TeiTheTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/tei/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('birthdayButton', 'BirthdayTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/birthday/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('paddyButton', 'StPatrickTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/paddy/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('seaButton', 'SeaprincessyTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/seapony/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('octaviaButton', 'OctaviaTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/octavia/colors.css', '', false, false));
  bgPonyGroup.addButton(new ThemeButton('pfbtdorButton', 'PFBTDOR', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pfbtdor/colors.css', '', false, false));

  nonPonyGroup.addButton(new ThemeButton('toastButton', 'ToastTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/toast/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('attorneyButton', 'AttorneyTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/attorney/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('earButton', 'EarTubes', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/ear/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('tubeSockButton', 'TubeSock', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/tubesock/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('slamButton', 'SlamTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/slam/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('americaButton', 'AmericaTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/america/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('neonButton', 'NeonTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/neon/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('bufferButton', 'BufferTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/buffer/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('synchButton', 'SynchTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/synch/colors.css', '', false, false));
  nonPonyGroup.addButton(new ThemeButton('beeButton', 'BeeTube', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/bee/colors.css', '', false, false));
  ...
  fourthPartyGroup.addButton(new ThemeButton('tubenamiButton', 'Tubenami', 'https://dl.dropboxusercontent.com/u/28101770/Tubenami/tubenami.css', 'Created by The_Catman', isNewOrUpdated(2013, 7, 17), false));
  fourthPartyGroup.addButton(new ThemeButton('tubenamiLightButton', 'Tubenami-Light', 'https://dl.dropboxusercontent.com/u/28101770/Tubenami/tubenami_light.css', 'Created by The_Catman', isNewOrUpdated(2013, 7, 17), false));
  fourthPartyGroup.addButton(new ThemeButton('tubenamiTestButton', 'Tubenami-Test', 'https://dl.dropboxusercontent.com/u/28101770/Tubenami/tubenami_test.css', 'Created by The_Catman', isNewOrUpdated(2013, 7, 17), false));
  fourthPartyGroup.addButton(new ThemeButton('tubenamiTestLightButton', 'Tubenami-Test-Light', 'https://dl.dropboxusercontent.com/u/28101770/Tubenami/tubenami_light_test.css', 'Created by The_Catman', isNewOrUpdated(2013, 7, 17), false));
  ...
  OHMY = new Audio('http://btc.berrytube.tv/toastdeib/js/toastthemes/ohmy.wav');
  OHMY.volume = 0.5;
  SHOOBEEDOO = new Audio('http://btc.berrytube.tv/toastdeib/js/toastthemes/shoobeedoo.wav');
  SHOOBEEDOO.volume = 0.5;
  imageVisible = false;
  showBonusPonies = getStoredBoolean('showBonusPonies', true);
  slamming = false;
  welcomeToTheJam = new Audio('http://btc.berrytube.tv/toastdeib/toastthemes/css/slam/slam.wav');
  ...
  var chevUpDiv = $('<div id="chevronUpDiv"/>').addClass('chevronDiv transparent').css('display', 'inline-block').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/chevup.png">').click(toggle);
  var chevDownDiv = $('<div id="chevronDownDiv"/>').addClass('chevronDiv').css('display', 'none').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/chevdown.png">').click(toggle);
  ...
  var effectsButtonDiv = $('<div id="effectsButtonDiv"/>').addClass('settingsButtonDiv').css('display', 'none').text('Effects').click(function() {
    toggleThemeListDiv('effectsContainer');
  });
  ...
  $('<div id="chevronButtonDiv"/>').addClass('chevronButtonContainerDiv').append(chevUpDiv, chevDownDiv), settingsButtonDiv, effectsButtonDiv, motdButtonDiv);
  ...
  $('<button id="randomButton"/>').addClass('themeButton').text('Randomize!').click(function() {
    setColorTheme(randomTheme(), false);
  ...
  // Create the MOTD div
  var motdMessage = 'Apparently CISPA is back. Hurr durr. <a href="http://www.cispaisback.org/" target="_blank">http://www.cispaisback.org/</a>';
  ...
  $('<div id="settingsDiv"/>').addClass('settingsPane').css('display', 'inline-block').html('<table class="settingsTable">' + '<tr><th colspan="2">ToastThemes Settings</th></tr>' + '<tr><td colspan="2" class="header">General Settings</td></tr>' + '<tr><td>Enable automatic themes:</td><td><input type="checkbox" id="chkEnableAutoThemes"></input></td></tr>' + '<tr><td>Enable poll notify sound:</td><td><input type="checkbox" id="chkEnablePollNotify" onchange="enablePollNotifyToggled()"></input></td></tr>' + '<tr><td>Use alternate poll sound:</td><td><input type="checkbox" id="chkUseAlternatePollSound"></input></td></tr>' + '<tr><td>Show main 6 bonus ponies:</td><td><input type="checkbox" id="chkShowBonusPonies"></input></td></tr>' + '<tr><td colspan="2" class="header">Chat Buffer Management Settings <span title="Chat Buffer Management will help prevent script-added page elements from jumping. When enabled, it will automatically trim the chat buffer to the specified line length with the specified interval. Elements may jump when the buffer is trimmed, which automatically happens 1 line at a time when it hits 500 lines. This feature will help prevent it from reaching that 500-line point, minimizing the amount of jump you see." style="cursor: default;">(?)</span></td></tr>' + '<tr><td>Enable buffer management:</td><td><input type="checkbox" id="chkEnableCBMS"></input></td></tr>' + '<tr><td>Line count to trim to:</td><td><input type="text" id="txtTrimLength" style="width: 30px;"></input></td></tr>' + '<tr><td>Trim interval (seconds):</td><td><input type="text" id="txtInterval" style="width: 30px;"></input></td></tr>' + '</table><br/>' + '<div class="controlButtonDiv"><button id="settingsCancel" class="controlButton" style="margin-right: 5px;">Cancel</button><button id="settingsApply" class="controlButton" style="margin-left: 5px;">Save</button>'));
  ...
  $('<div/>').css('padding', '4px 5px 3px 5px').css('text-decoration', 'underline').text('Effects'), $('<div/>').addClass('themeButtonWrapper').append($('<button id="gakifyButton"/>').addClass('themeButton').text('GAKIFY').click(gakAttack)), $('<div/>').addClass('themeButtonWrapper').append($('<button id="wobniarButton"/>').addClass('themeButton').text('wobniaR').click(wobniar)), $('<div/>').addClass('themeButtonWrapper').append($('<button id="rot13Button"/>').addClass('themeButton').text('rot13').click(rot13)), $('<div/>').addClass('themeButtonWrapper').attr('title', 'Warning: This can only be undone by refreshing!').append($('<button id="sehroButton"/>').addClass('themeButton').html('sehro-Vision&trade;').click(sehroVision)), $('<div/>').addClass('themeButtonWrapper').append($('<button id="brodyButton"/>').addClass('themeButton').text('Brody-Vision').click(brodyVision)), $('<div/>').addClass('themeButtonWrapper').append($('<button id="ddosButton"/>').addClass('themeButton').text('Breadstick DDoS').click(breadstickDdos)));
  ...
  $('<div id="mailMessageDiv"/>'), $('<div/>').css('text-align', 'center').append(
  $('<button/>').addClass('themeButton').text('Clear').click(function() {
    $('#mailMessageDiv').children().remove();
    $('#mailButtonDiv').removeClass('new');
    toggleMailDiv();
  }))), $('<div id="mailButtonDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/envelope.png"></img>').click(toggleMailDiv)));

  // Create the HI! div
  $body.append($('<div id="hiDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/hi.png"></img>'));

  // Create the grumpy div
  $body.append($('<div id="grumpyDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/grumpy.png"></img>'));

  // Create the chainsaw div
  $body.append($('<div id="chainsawDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/chainsaw.png"></img>'));
  ...
  socket.on('forceVideoChange', function(data) {
    ...
    if (data.video.videoid == 'FZmzIzWWA8M') {
      //And the Moon orbits Around the World...
      $('#videowrap').css('position', 'relative').append($('<div id="crawlyBelle"/>').html('<img src="http://btc.berrytube.tv/toastdeib/js/toastthemes/stare.png"></img>').attr('style', 'bottom: 100%; margin-bottom: -70px; right: 100%; margin-right: -70px; -webkit-transform: rotate(180deg); -moz-transform: rotate(180deg);'));
    ...
    if (autoThemeEnabled) {
      ...
      case '0Ntiphuey8g':
        // I'm making... TOAST!
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/toast/colors.css';
        break;
      case 'lhjk5x54bsE':
        // Turnabout Turntable
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/attorney/colors.css';
        break;
      case 'W7VRIC2TEs8':
      case 'cjwzwj2ebeg':
        // Tropical Octav3
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/octav3/colors.css';
        break;
      case 'Inj-jnZa9BU':
        // Here Comes Tom
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/tom/colors.css';
        break;
      case 'L0cY2NWlddU':
        // Two Best Sisters Play Portal 2
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/ear/colors.css';
        break;
      case 'u1aOQIX2W-0':
        // SOCK
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/sock/colors.css';
        break;
      case 'cg8W_QYeL00':
        // Twist and Shout
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/twist/colors.css';
        break;
      case 'fk8VdtjNsE8':
        // Inspector Brushie
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/toothpaste/colors.css';
        break;
      case 'NXnwQ9TSAOg':
        // The Changeling (Twitch Remix)
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/deskfuck/colors.css';
        break;
      case 'Hnqz9OdZjRQ':
        // Beep Beep!
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/cmc/colors.css';
        break;
      case '0EdAAZ2x5-E':
      case 'hS-oZ_Nkp6g':
        // America, Fuck Yeah! (two versions)
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/america/colors.css';
        break;
      case 's7YB8yy9XAg':
      case 'hHBfZxr2yLA':
        // Flying With the Rainbow (two versions)
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/tei/colors.css';
        break;
      case 'EiO9_PJ0h8Q':
        // Neon Pegasus
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/neon/colors.css';
        break;
      case '-WIxWkby8ok':
        // I'm bringing the party to you
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/birthday/colors.css';
        break;
      case 'cDuG95DXbw8':
        // Race Like Rainbow Dash
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/dashie/colors.css';
        break;
      case 'qQSz6gKdhO8':
        // Shine Like Rarity
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/rarity/colors.css';
        break;
      case 'rT31ZeCNdBw':
        // Strive Like Applejack
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/apple/colors.css';
        break;
      case 'EXpauql2lqM':
        // Learn Like Twilight Sparkle
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/sparkle/colors.css';
        break;
      case 'ikV8LL_YHv0':
        // Love Like Fluttershy
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/flutter/colors.css';
        break;
      case '6UXGEbaP5Ug':
        // Play Like Pinkie Pie
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/colors.css';
        break;
      case 'P4TedkQP_hM':
      case '3_dDxISCOuM':
        // Call Upon the Seaponies
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/seapony/colors.css';
        break;
      case 'wHwyca7gu7E':
      case '9w6Wa0W2y_o':
        // Super Weed Bros. and Green & Purple
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/blazeit/colors.css';
        break;
      case 'qRC4Vk6kisY':
        // Fluffle Puff Tales: PFUDOR
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pfbtdor/colors.css';
        break;
      case '3DSbowW5j34':
        // Soviet Pony March
  ...
  socket.on('hbVideoDetail', function(data) {
    if (autoThemeEnabled && autoThemeTimeoutId == -1) {
      ...
      case 'wXIHH6C61I0':
        ...
        offset = 47 - data.time;
        targetTheme = 'http://btc.berrytube.tv/toastdeib/toastthemes/css/apocalypse/colors.css';
        break;
      }

      if (offset > 0 && targetTheme != currentTheme) {
        log('Setting ' + targetTheme + ' to load in ' + offset + ' seconds');
        autoThemeTimeoutId = setTimeout(function() {
          setColorTheme(targetTheme, true);
        }, offset * 1000);
      }
    }
  });
  ...
  socket.on('chatMsg', function(data) {
    if (data.msg.emote == false && data.msg.nick != NAME && NAME.length > 0 && detectName(NAME, data.msg.msg) && !WINDOW_FOCUS) {
...
function applySettings() {
  ...
  if (tmpTrimLength && tmpInterval && ((tmpEnabled != cbmsEnabled) || (tmpTrimLength != cbmsTrimLength) || (tmpInterval != cbmsInterval))) {
...
function addNewMailMessage(nick, msg) {
  ...
  var now = new Date();
  newMsg.append(
  $('<span/>').addClass('timestamp').text('<' + padTime(now.getHours()) + ":" + padTime(now.getMinutes()) + ":" + padTime(now.getSeconds()) + '>'), $('<span/>').addClass('nick').text(nick + ':'),
  // Abbreviated form of formatChatMsg(), since we only want the hyperlinking and not >greentext
  $('<span/>').html(msg.replace(/(http[s]{0,1}:\/\/[^ ]*)/ig, '<a href="$&" target="_blank">$&</a>')), $('<button/>').addClass('themeButton').css('width', '20px').text('X').click(function() {
    $(this).parent().remove();
...
function addThemeEffect(theme) {
  switch (theme) {
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/slam/colors.css':
    slamming = true;
    welcomeToTheJam.play();
    $('#videowrap').append(
    $('<div id="barkleyDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/slam/images/barkley.png">').click(function() {
      welcomeToTheJam.play();
    }));
    barkleyJump();
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/fancy/colors.css':
    $('#videowrap').append(
    $('<div id="fancyHatDiv"/>').css('display', 'none').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/fancy/images/player_hat.png">'), $('<div id="fancyStacheDiv"/>').css('display', 'none').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/fancy/images/player_mustache.png">'), $('<div id="fancyMonocleDiv"/>').css('display', 'none').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/fancy/images/player_monocle.png">'), $('<div id="fancyToggleDiv"/>').html('Fancy<br/>OFF').click(toggleFancy));
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/dashie/colors.css':
    if (showBonusPonies) {
      $('#chatpane').append(
      $('<div id="chatDashieDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/dashie/images/chat_dashie.png">'), $('<div id="chatScootsDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/dashie/images/chat_scoots.png">'));
    }
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/rarity/colors.css':
    if (showBonusPonies) {
      $('#playlist').css('position', 'relative').append(
      $('<div id="playlistRarityDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/rarity/images/playlist_rarity.png">'));
    }
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/apple/colors.css':
    if (showBonusPonies) {
      $('#playlist').append(
      $('<div id="playlistAjDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/apple/images/playlist_aj.png">'));
    }
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/sparkle/colors.css':
    if (showBonusPonies) {
      $('#videowrap').append(
      $('<div id="playerTwilightDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/sparkle/images/player_twilight.png">'));
    }
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/flutter/colors.css':
    if (showBonusPonies) {
      $('#chatControls').append(
      $('<div id="chatFluttershyDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/flutter/images/chat_fluttershy.png">'));
    }
    break;
  case 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/colors.css':
    if (showBonusPonies) {
      $('#chatpane').append(
      $('<div id="aboveChatPinkieDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/images/abovechat_pinkie.png">'), $('<div id="belowChatPinkieDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/images/belowchat_pinkie.png">'));
      $('#videowrap').append(
      $('<div id="playerPinkieDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/images/player_pinkie.png">'));
      $('#playlist').append(
      $('<div id="playlistPinkieDiv"/>').html('<img src="http://btc.berrytube.tv/toastdeib/toastthemes/css/pinkie/images/playlist_pinkie.png">'));
    }
    break;
  }
}
...
function breadstickDdos() {
  ...
  if (ddos.length == 0) {
    $('body').append(
    $('<div/>').addClass('breadstickDdos').css('background', 'url(http://btc.berrytube.tv/toastdeib/js/toastthemes/breadsticks.png) repeat'), $('<div/>').addClass('breadstickDdos').css('background', 'url(http://btc.berrytube.tv/toastdeib/js/toastthemes/breadsticks2.png) repeat'));
