...
function initToastThemes(data, textStatus, jqxhr) {
  ...
  bgPonyGroup = new GroupButton('bgPonyGroup', 'Background Pony', isNewOrUpdated(2013, 6, 6), false);
  nonPonyGroup = new GroupButton('nonPonyGroup', 'Non-Pony', false, false);
  fourthPartyGroup = new GroupButton('fourthPartyGroup', '4th Party', false, false);
  ...
  bgPonyGroup.addButton(new ThemeButton('pfbtdorButton', 'PFBTDOR', 'http://btc.berrytube.tv/toastdeib/toastthemes/css/pfbtdor/colors.css', '', isNewOrUpdated(2013, 6, 6), false));
  ...
  fourthPartyGroup.addButton(new ThemeButton('namiButton', 'Tubenami', 'https://dl.dropboxusercontent.com/u/28101770/Tubenami/layout3.css', 'Created by The_Catman for Tubenami', false, false));
